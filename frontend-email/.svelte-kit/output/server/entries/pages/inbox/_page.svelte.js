...
import { o as onDestroy, r as realtimeStore, S as Search, I as Input, W as Wifi, a as Wifi_off, B as Button, M as Moon, b as Settings, c as MailboxList, e as emailStore, d as MessageDetail, f as MessageList, C as Composer, g as Sun } from "../../../chunks/realtime.svelte.js";
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      head("9rszxv", $$renderer3, ($$renderer4) => {
        $$renderer4.title(($$renderer5) => {
          $$renderer5.push(`<title>Inbox - Arack Mail</title>`);
        });
      });
