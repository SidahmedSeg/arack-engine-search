<script lang="ts">
	...
	onMount(async () => {
		// Phase 9: SSO authentication is handled by hooks.server.ts
		// No OAuth check needed - user is already authenticated via arack_session
