/**
 * OAuth 2.0 / OIDC Client for Arack Search
...
const REDIRECT_URI = import.meta.env.VITE_OAUTH_REDIRECT_URI || 'https://arack.io/oauth/callback';
...
export async function login() {
	try {
		...
		console.log('[OAuth] Redirecting to authorization endpoint:', authorizationUrl.toString());
