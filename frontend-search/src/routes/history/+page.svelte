<script lang="ts">
	...
	async function loadHistory() {
		...
		try {
			const response = await axios.get(`http://127.0.0.1:3000/api/ory/search-history?limit=100`, {
...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 pt-20 px-4">
	<div class="container mx-auto max-w-6xl">
		...
		<div class="mb-6">
			...
			<p class="text-gray-600 dark:text-gray-400">View and search through your past queries</p>
		</div>
